...
@DisplayName("PublicarEventoHistoricoUseCase Tests")
class PublicarEventoHistoricoUseCaseTest {
    ...
    @InjectMocks
    private PublicarEventoHistoricoUseCase publicarEventoHistoricoUseCase;
    ...
    void devePublicarEventoConsultaCriadaComSucesso() {
        // When
        publicarEventoHistoricoUseCase.executar(consultaCriadaEvent);
    ...
    void devePublicarEventoConsultaEditadaComSucesso() {
        // When
        publicarEventoHistoricoUseCase.executar(consultaEditadaEvent);
