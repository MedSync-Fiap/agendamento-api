...
O sistema publica eventos para outros microsserviços:

### Exchanges
- `ex_consultas`: Exchange principal para eventos de consultas

### Filas
- `fila_historico`: Para o serviço de histórico
- `fila_notificacoes`: Para o serviço de notificações

### Eventos
- `consulta_criada_historico`: Quando uma consulta é criada
- `consulta_criada_notificacao`: Para notificar sobre nova consulta
- `consulta_editada_historico`: Quando uma consulta é editada
- `consulta_editada_notificacao`: Para notificar sobre alteração
...
```
src/test/java/com/medsync/cadastroagendamento/application/usecases/
